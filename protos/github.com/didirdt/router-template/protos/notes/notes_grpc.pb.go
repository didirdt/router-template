...
func (c *notesClient) GetNote(ctx context.Context, in *GetNoteReq, opts ...grpc.CallOption) (*GetNoteResp, error) {
...
func (UnimplementedNotesServer) GetNote(context.Context, *GetNoteReq) (*GetNoteResp, error) {
...
func _Notes_GetNote_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NotesServer).GetNote(ctx, req.(*GetNoteReq))
	}
